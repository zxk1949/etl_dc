...
if __name__ == '__main__':
    ...
    syncTable.sync('immanager', 'im_loginout_history', 'date_when', 'im_loginout_history_20201211_later', 15, 1, '')
    syncTable.sync('immanager', 'im_pmsg_pendingprocess', 'created_when', 'im_pmsg_pendingprocess_20210113_later', 30,1, '')
    #syncTable.sync('immanager', 'im_pmsg_pendingprocess', 'created_when', 'im_pmsg_pendingprocess_20210113_later', 30, 1, '')
    syncTable.sync('immanager', 'im_pmsghistory', 'sent_when', 'im_pmsghistory_history', 30, 1, '')
    syncTable.sync('immanager', 'im_tasksend_history', 'created_time', 'im_tasksend_history_history', 15, 1, '')
