...
if __name__ == '__main__':
    ...
    #syncTable.sync('order_center', 'order_course_package', 'created_time', 'order_course_package_history', 0, 1500,'created_type = 90 and has_formal_package = 1')
    syncTable.sync('immanager', 'im_pmsghistory', 'sent_when', 'im_pmsghistory_history', 30, 1000, '')
